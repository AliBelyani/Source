...
namespace DK.API.Shared
{
    ...
    {
        public static string ToStringValue(this IFormCollection collection, string key)
        {
            if (!collection.TryGetValue(key, out var myValues))
            {
                return "";
            }
            return myValues.Any() ? myValues[0] : "";
        }
        ...
        public static string GetFileExtension(string mimeType)
        {
            ...
            try
            {
                return Mappings.First(d => d.Value.ToLower() == mimeType).Key;
            }
            catch (Exception e)
            {
                return "";
        ...
        public static string GetFolder(string extension)
        {
            string folder;
            switch (extension)
            {
